...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        $sell = DB::table("sell_details")->join('products', 'sell_details.product_id', '=', 'products.id')
            ...
            DB::raw("SUM(sell_details.unit_product_cost * sell_details.sale_quantity) as total_cost"),
            DB::raw("SUM(sell_details.unit_sell_price * sell_details.sale_quantity) as total_sell_price"),
        )
            ->get()[0];
