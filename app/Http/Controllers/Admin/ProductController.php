...
class ProductController extends Controller
{
    ...
    public function deleteProduct(Request $request)
    {
        ...
        // Optionally, you might want to delete associated images or perform other cleanup tasks
    ...
    //     $subcategory = ProductSubCategory::all().foreach($subcategory-> $subcategory;
