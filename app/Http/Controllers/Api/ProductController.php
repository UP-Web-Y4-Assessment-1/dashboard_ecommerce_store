...
class ProductController extends Controller
{
    ...
    {
        return ProductResource::collection(Product::where('is_trending', 1)->where('deleted', 0)->where('status', 1)->paginate(8));
    }
...
//        return $productlist;
    ...
    {
        $newArrival = Product::orderBy('id', 'DESC')->take(12)->where('deleted', 0)->where('status', 1)->get();
