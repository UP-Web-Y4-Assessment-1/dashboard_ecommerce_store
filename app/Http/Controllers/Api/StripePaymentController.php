...
class StripePaymentController extends Controller
{
    ...
    //         Stripe\Stripe::setApiKey("sk_test_51Hn0KpLK8vTcfU7CGNdpxG6tzyR7Z71O3GopLjibYBRWJdO4sPPivpY9D377Jeho5U1Ca0Oh99kXblo4Eqv7z75D00RPHWs2PB");
    ...
    //         $shippingInfo->shipping_city = "Phnom Penh";
    ...
    public function stripePayment(Request $request)
    {
        ...
        try {
            ...
            $shippingAddress = new SellOrderAddress();
            $shippingAddress->email = $email;
            $shippingAddress->name = $name;
            $shippingAddress->sell_id = $sell->id;
            $shippingAddress->user_id = Auth::user()->id;
            $shippingAddress->shipping_phone = $phone;
            $shippingAddress->shipping_address = $address;
            $shippingAddress->shipping_city = $city;
            $shippingAddress->shipping_country = $country;
            $shippingAddress->shipping_zip = $post_code;
            $shippingAddress->shipping_division = $shipping_division;
            $shippingAddress->shipping_district = $shipping_district;
