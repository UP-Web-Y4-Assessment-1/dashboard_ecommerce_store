                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" align="center" width="100" style="background-color:#ffffff">
                                                <img alt="{{$company_info_share->name}}" style="width:100px;height: 100px" src="{{public_path ($company_info_share->company_logo) }}">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="100">
                                                ...
                                                <p>Payment method: <span style="font-size:18px;font-weight:bold">{{$details['data']->payment_type===1 ? $details['data']->paymentInfo->card_brand : 'Cash on Delivery'}}</span>
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" style="font-size:24px;">
                                                <span style="text-decoration:underline;">Order No: # {{$details['data']->invoice_id}}</span>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <h4 style="font-size:24px;margin:0;padding:0;margin-bottom:10px;">Customer
                                                    Details</h4>
                                                <p style="margin:0;margin-bottom:10px;padding:0;"><strong>Email:</strong> <a href="mailto:remuleo@gmail.com" target="_blank">{{$details['data']->orderAddress->email}}</a></p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <strong>Tel:</strong> {{$details['data']->orderAddress->shipping_phone}}
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
