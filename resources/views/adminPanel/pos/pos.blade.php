                ...
                <div class="rightpos">
                    <div class="row d-flex justify-content-center align-items-center posTopbar">
                        ...
                        <div class="col-sm-4 d-flex justify-content-end">
                            <span class="addCustomer" onclick="customeradd()"><i style="font-size: 18px;" class="lni lni-circle-plus"></i> &nbsp; Customer</span>
                        </div>
                    </div>
                        ...
                        <div class="posfooter_st">
                            <div class="details_bs">
                                <div style="display: flex;padding: 0px 10px" class="discountinput">
                                    <select name="discount_type" class="form-select" id="distypeset" onchange="countTotal()">
                                        <option value="0">Fixed</option>
                                        <option value="1">Percentage (%)</option>
                                    </select> &nbsp;
                                    <input type="number" name="total_discount" value="" id="discountamountset" oninput="countTotal()" class="form-control" placeholder="Discount">
                                </div>
...
<script>
    ...
    function countTotal() {
        ...
        $('#discountamountset').val(totalDiscount);
    ...
    //         }
    //         $('#totaDiscount').html(total_discount);
    //         // Set the value of the total_discount input field
    //         $('input[name="total_discount"]').val(total_discount);
    //     } else {
    //         total_discount = 0;
    //         $('#totaDiscount').html('00');
    //         // Set the value of the total_discount input field to 0 when no discount is entered
